...
const SUPPORTED_EXCHANGE_TEMPLATES = [
  ...
  {
    exchange_type: 'forex',
    name: 'Forex (TwelveData)',
    type: 'forex' as const,
  },
  {
    exchange_type: 'metals',
    name: 'Metals (TwelveData)',
...
export function ExchangeConfigModal({
  ...
  > = {
    ...
    forex: { url: 'https://twelvedata.com/', hasReferral: false },
    metals: { url: 'https://twelvedata.com/', hasReferral: false },
  }
          ...
          >
            ...
            <button
              ...
              disabled={
                ...
                (currentExchangeType === 'bybit' &&
                  (!apiKey.trim() || !secretKey.trim())) ||
                // CEX and new types (stock/forex/metals) require API Key + Secret
                ((selectedTemplate?.type === 'cex' ||
                  selectedTemplate?.type === 'stock' ||
                  selectedTemplate?.type === 'forex' ||
                  selectedTemplate?.type === 'metals') &&
                  currentExchangeType !== 'hyperliquid' &&
                  currentExchangeType !== 'aster' &&
                  currentExchangeType !== 'lighter' &&
                  currentExchangeType !== 'binance' &&
